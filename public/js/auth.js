...
document.addEventListener('DOMContentLoaded', function() {
            ...
            if (isValid) {
                ...
                if (isAdminLogin) {
                    ...
                    const userData = {
                        ...
                        name: email.value.split('@')[0], // Just use part of email as name for demo
                        role: 'client'
                    };
    ...
    // Check if we're on the admin page and user is not an admin
    if (window.location.pathname.includes('admin.html') && (!isLoggedIn || !isAdmin())) {
        // Redirect to login page
