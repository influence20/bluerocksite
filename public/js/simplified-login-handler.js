/**
 * BlueRock Asset Management - Simplified Login Handler
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Remove two-factor authentication elements
    const twoFactorElements = document.querySelectorAll('.two-factor');
    twoFactorElements.forEach(element => {
        element.style.display = 'none';
    });
    
    // If login tabs exist, set up tab switching
    if (loginTabs && clientTab && adminTab) {
        ...
        // If tabs don't exist, use the admin login link
    ...
    function switchToAdminMode() {
        ...
        if (loginForm) {
            ...
            if (emailField) {
                ...
                // Remove any pattern attribute that might cause validation issues
    ...
    function switchToClientMode() {
        ...
        if (loginForm) {
            ...
            // Change username field back to email
            ...
            if (usernameField) {
                ...
                usernameField.placeholder = 'Enter your email address';
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', function(e) {
            ...
            if (isAdminLogin) {
                ...
                // If form is valid, attempt admin login
                if (isValid) {
                    // Only accept specific admin credentials
                    if (username.value.trim() === 'admin' && password.value === 'influence789') {
                ...
                // If form is valid, attempt client login
                if (isValid) {
                    // Only accept specific client credentials
                    const validUsers = [
